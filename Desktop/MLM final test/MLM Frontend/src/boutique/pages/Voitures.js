...
import VoitureCard from "../components/VoituresCard";
...
const Voitures = () => {
  ...
  return (
    <>
      <Meta title={"Accessoires Voitures"} />
      <BreadCrumb title="Accessoires Voitures" />
      <Container class1="store-wrapper home-wrapper-2 py-5 ms-5">
        <div className="row">
          <div className="col-3">
          ...
          <div className="col-9">
            ...
            <div className="products-list pb-5">
              <div className="d-flex flex-wrap">
                <VoitureCard data={productState ? productState : []} grid={grid} />
              </div>
            </div>
          </div>
        </div>
