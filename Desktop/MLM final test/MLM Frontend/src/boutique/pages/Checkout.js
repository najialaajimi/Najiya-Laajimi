...
const CheckoutSchema = yup.object({
  ...
  address: yup.string().required("Address est obligatoire"),
  state: yup.string().required("State est obligatoire"),
  city: yup.string().required("City est obligatoire"),
  country: yup.string().required("Country est obligatoire"),
  other: yup.string().required("Other est obligatoire"),
  pincode: yup.number().required("Pincode est obligatoire"),
});
...
const Checkout = () => {
  ...
  const authState = useSelector((state) => state.authweb.user);
  useEffect(() => {
    let sum = 0;
  ...
  const checkoutHandler = async () => {
    ...
    const options = {
      key: "rzp_test_5fWSYlV8nNCQ44", // Enter the Key ID generated from the Dashboard
      amount: amount,
      currency: currency,
      name: "Developper.",
      ...
      prefill: {
          name: "Developper",
          email: "devellopper2@example.com",
          contact: "9999999999",
      },
      notes: {
          address: "Developper Office",
      },
      theme: {
          color: "#61dafb",
      },
        ...
        <div className="row">
          <div className="col-7">
            <div className="checkout-left-data">
              <h3 className="website-name">Facture</h3>
              <nav
              ...
              {authState?.firstname} {authState?.lastname} <br />
                <b>{authState?.email}</b>
              </p>
          ...
          <div className="col-5">
            ...
            <div className="d-flex justify-content-between align-items-center border-bootom py-4">
              <h4 className="total">Totale</h4>
              <h5 className="total-price">
                {totalAmount ? totalAmount + 5 : "0"} DT
              </h5>
            </div>
          </div>
        </div>
